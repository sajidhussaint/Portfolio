    ...
    return (
        <Nav>
            <NavContainer className={isScroll ? "scrolled" : ""}>
                ...
                <ButtonContainer>
                    <Button href="https://github.com/sajidhussaint/" target="blank">Github</Button>
                    <Button href="https://www.linkedin.com/in/sajid-hussain-17b6b21b8/" target="blank">LinkedIn</Button>
                </ButtonContainer>
                    ...
                    isOpen && 
                            <MobileMenu isOpen={isOpen}>
                                ...
                                <MobileButtonContainer isOpen={isOpen}>
                                    <MobileButton href="https://github.com/kjc 666" target="blank">Github</MobileButton>
                                    <MobileButton href="https://linkedin.com/in/kjc 666" target="blank">LinkedIn</MobileButton>
